...
def plot_confusion_matrix(true_labels, pred_labels, output_base, title, xlabel="Predicted Genotype", tool_name="DefaultTool", coverage=10):
    labels = ["0/0", "0/1", "1/1"]
...
def get_benchmark_info(genotype_df, benchmark_out_file, cm_output_base, cm_title, cm_xlabel, tool, Coverage):
    benchmark_result = {}
    ...
    plot_confusion_matrix(true_labels, pred_labels, cm_output_base, cm_title, cm_xlabel, tool, Coverage)
...
def main(args=None):
    ...
    parser.add_argument("--coverage", type=str, default="10", help="The tool being evaluated")
    ...
    get_benchmark_info(geno_df, benchmark_out_file, cm_output_base, cm_title, cm_xlabel, tool, coverage)
