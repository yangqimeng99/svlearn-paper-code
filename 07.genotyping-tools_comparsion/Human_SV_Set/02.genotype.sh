...
do
	...
	svlearn genotype \
		...
		-n ${sample}_${coverage} \
		-o ${sample}_${coverage}.pred.all.18fea.30x.vcf
	bgzip -c ${sample}_${coverage}.pred.all.18fea.30x.vcf > ./${sample}.svlearn_18.${covergae}.30x-model.vcf.gz
	...
	svlearn genotype \
		...
		-n ${sample}_${coverage} \
		-o ${sample}_${coverage}.pred.all.24fea.30x.vcf
	bgzip -c ${sample}_${coverage}.pred.all.24fea.30x.vcf > ./${sample}.svlearn_24.${covergae}.30x-model.vcf.gz
