...
do
	...
	svlearn prepareAlt \
		...
		--ref_sv_vcf ../HG00514.SV_25006.REF_HOM_${num}.vcf \
		--min-distance 300 \
		--out filter300_HG00514.SV_25006.REF_HOM_${num}
	
	filter300_output="filter300_HG00514.SV_25006.REF_HOM_${num}"
	...
	do
		bcftools view -i "ID=@00.list/${SVTYPE}_sv_${num}.list" ../HG00514.SV_25006.REF_HOM_${num}.vcf | bcftools view -s ${sample} > 01.true_vcf/${sample}.${num}.${SVTYPE}.true_GT.vcf
	done
...
csvtk concat -t */*/HG00514.*.bench.row.tsv > ${sample}.benchmark_6tools.tsv
