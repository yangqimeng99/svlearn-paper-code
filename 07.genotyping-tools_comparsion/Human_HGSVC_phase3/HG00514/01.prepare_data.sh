...
bwa-mem2.avx512bw index ../../../01.data_download/human/reference_genomes/human_GRCh38_full_analysis_set_plus_decoy_hla_REF.fasta
# mapping
...
do
    mkdir HG00514.SV_25006.REF_HOM_${num}
