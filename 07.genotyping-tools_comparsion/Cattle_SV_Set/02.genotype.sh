...
region="cattle.genotyping_sv.region"
ref_genome="../../01.data_download/cattle/reference_genomes/cattle_ARS-UCD2.0_GCF_002263795.3_REF.fasta"
refCanon="../../01.data_download/cattle/reference_genomes/cattle.canon.fasta"
refDecoy="../../01.data_download/cattle/reference_genomes/cattle.decoy.fasta"
svlearn_feature_dir="../../05.feature_extraction/Cattle_SV_Set"
models_dir="../../06.model_training_test/Cattle_SV_Set"
species="cattle"
sample="Charolais"
...
do
	...
	svlearn genotype \
		...
		--model ${models_dir}/RF-models_18feature/lack.${sample}.RF-model/RandomForest_model.joblib \
	...
	svlearn genotype \
		-v ${prepareAlt_output}/ref_sorted_format_filtered_sv.vcf \
		--model ${models_dir}/RF-models_24feature/lack.${sample}.RF-model/RandomForest_model.joblib \
		-s ${svlearn_feature_dir}/sv_feature.tsv \
		-a ${svlearn_feature_dir}/${sample}_${coverage}.alignFeature/BreakPoint_ReadDepth_2Bam_feature.tsv \
	...
	# paragraph
	gunzip -c ${svlearn_feature_dir}/${sample}_${coverage}.paraFeature/ref_paragraph_out/genotypes.vcf.gz | \
