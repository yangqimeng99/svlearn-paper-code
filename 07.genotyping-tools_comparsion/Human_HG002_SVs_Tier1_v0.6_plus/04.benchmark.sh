true_sv_set="Human_HG002_SVs_Tier1_v0.6_plus.vcf"
sample="HG002"


awk '$1!="sv_id"' sv_feature.tsv | cut -f1 > all_sv.list # all.sv.list
...
csvtk concat -t */HG002.*.bench.row.tsv > HG002_SVs_Tier1_v0.6_plus_benchmark.tsv
