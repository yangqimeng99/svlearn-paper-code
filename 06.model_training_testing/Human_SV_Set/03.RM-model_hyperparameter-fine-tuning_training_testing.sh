...
# Train the model on the training datasets with 20x, 10x, and 5x coverages,
# excluding the HG002 sample. Use the corresponding HG002 coverage dataset for testing.
sample="HG002"
