...
do
	python ${scripts}/feature_importance.py \
		--model ../RF-models_18feature/lack.${sample}.${coverage}x.RF-model/RandomForest_model.joblib \
	...
	python ${scripts}/feature_importance.py \
		--model ../RF-models_24feature/lack.${sample}.${coverage}x.RF-model/RandomForest_model.joblib \
