...
RepeatMasker -pa 64 -engine ncbi -species Bovidae -xsmall -s -no_is -cutoff 255 -frag 20000 -dir ./ -gff ref.fasta
RepeatMasker -pa 64 -engine ncbi -species Bovidae -xsmall -s -no_is -cutoff 255 -frag 20000 -dir ./ -gff alt.fasta
